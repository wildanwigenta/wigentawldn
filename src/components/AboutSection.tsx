          ...
          >
            <div className="space-y-4">
              ...
              <p className="text-gray-300 leading-relaxed text-lg">
                ...
                creating meaningful digital experiences. My journey in the world
                of technology began with curiosity and has grown into a
                dedicated pursuit of excellence in web development and graphic
                design.
              </p>
              ...
              <p className="text-gray-300 leading-relaxed">
                ...
                technologies such as React, Next.js, Laravel, and Tailwind CSS.
                I believe in writing clean, maintainable code that not only
                performs well but also delivers an outstanding user experience.
              </p>
              ...
              <p className="text-gray-300 leading-relaxed">
                ...
                perfectly complement my development expertise. By leveraging
                tools like Figma, Adobe Photoshop, and CorelDRAW, I design
                visually compelling interfaces that are both functional and
                aesthetically pleasing.
              </p>

              <p className="text-gray-300 leading-relaxed">
                I am committed to continuous learning and staying up-to-date
                with the latest technologies and industry trends. My goal is to
                bridge the gap between design and development, creating
                seamless, innovative digital solutions that exceed expectations.
              </p>
            </div>
